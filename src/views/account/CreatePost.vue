<template>
    <div id="CreatePost" class="container max-w-4xl mx-auto pt-20 pb-20 px-6">
        ...
        <div class="flex flex-wrap mt-4 mb-6">
            <div class="w-full md:w-1/2 px-3">
                <DisplayCopperButton @showModal="showModal = true" label="Post Image" btnText="Add Post Image" />
            </div>
        </div>
        <div class="flex flex-wrap mt-4 mb-6">
            <div class="w-full md:w-1/2 px-3">
        ...
        <div class="flex flex-wrap mt-4 mb-6">
            <div class="w-full px-3">
                <TextArea label="Description" placeholder="Please enter some information here!!!" v-model:description="description" :error="errors.description ? errors.description[0] : '' " />
            </div>
        </div>
