<template>
    <div id="AddYoutubeVideo" class="container mx-auto max-w-4xl pt-20 px-6">
        ...
        <TextInput label="Title" class="mb-6" placeholder="Cool New Video" v-model:input="title" inputType="text" :error="errors.title ? errors.title[0] : '' "/>
        <TextInput label="Video URL" class="mb-2" placeholder="AefxxefrotByyite" v-model:input="videoCode" inputType="text" :error="errors.url ? errors.url[0] : '' "/>
