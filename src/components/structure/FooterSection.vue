<template>
    <div class="w-full bg-black text-gray-100">
        <div class="container mx-auto max-w-full h-full flex flex-wrap justify-between items-start text-sm p-6 pt-8 pb-4">
            <div class="">
        ...
        <div class="container mx-auto max-w-full h-full flex flex-wrap justify-between items-center text-sm py-6 pl-6 pr-4">
